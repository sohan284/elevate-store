    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm flex flex-col md:flex-row items-center gap-4">
          ...
          <button className="flex items-center justify-center gap-2 px-5 py-3 rounded-lg border border-gray-100 bg-white text-gray-600 hover:bg-gray-50 transition-colors text-[14px] font-bold w-full md:w-auto">
            <Filter size={18} />
            More Filters
          </button>
        </div>
