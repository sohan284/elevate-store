    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <select className="flex-1 md:flex-none bg-white border border-gray-100 rounded-lg px-5 py-3 text-[14px] font-bold text-gray-700 outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary/30 transition-all cursor-pointer min-w-[140px]">
                ...
                <tr key={product.id} className="border-b border-gray-50 last:border-0 hover:bg-[#F8F9FA]/80 transition-colors group">
                  ...
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center text-3xl shadow-sm shrink-0 group-hover:scale-110 transition-transform duration-300">
                        {product.images[0] || "📦"}
                      </div>
                      <div>
                        <h4 className="text-[14.5px] font-bold text-gray-900 group-hover:text-primary transition-colors">{product.name}</h4>
                        <p className="text-[11.5px] font-semibold text-gray-400 mt-1 uppercase tracking-wider font-mono">SKU ID: {product.sku}</p>
                      </div>
                    </div>
                  </td>
          ...
          <div className="flex items-center gap-2">
            {[1].map((n, i) => (
              <button
                key={i}
                className={cn(
                  "w-9 h-9 rounded-lg flex items-center justify-center text-[13px] font-bold transition-all",
